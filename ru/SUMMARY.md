...
* [Corezoid API](api/README.md)
   ...
   * [API v2](api/v2/README.md)
       ...
       * [Установка координат узла](api/v2/node-position.md)
...
* [Примеры](plugins/README.md)
   ...
   * [Очереди заявок в Corezoid](plugins/queue/README.md)
...
* [Bot Platform](bot-platform/README.md)
    * [v2.0](bot-platform/v2/README.md)
       ...
       * [Компоненты Bot Platform 2.0](bot-platform/v2/components.md)
       * [Расширение функций бота](bot-platform/v2/add-new-functionality.md)
       * [Авторизация пользователей по номеру телефона](bot-platform/v2/authorization.md)
