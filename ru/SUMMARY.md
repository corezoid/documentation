...
* [Bot platform 1.0](bot_platform/README.md)
* [Bot platform 2.0](bot_platform_v2/bot_platform_v2.md)
   * [Как создать бота с помощью Bot Platform](bot_platform_v2/create_bot.md)
   * [Базовый функционал Bot Platform](bot_platform_v2/basic_function.md)
   * [Объекты папки Bot Platform 2.0](bot_platform_v2/object_folder.md)
