...
- Улучшена функция поиска процессов по части его названия - увеличен лимит на вывод найденных вариантов в выпадающем списке с 20 до 30. При превышении лимита выдачи в 30 вариантов пользователю будет отображаться сообщение с рекомендацией повторить поиск по более уникальной части названия процесса:
![img](interface/img/releases/git_call.png)

![img](interface/img/releases/p1.png)

![img](/ru/interface/img/releases/m1_25р1.png)



- На странице авторизации добавлена **Google re Captcha**, которая отображается после 5ти неверных ввода пароля:
...
- Теперь с помощью функции **CONV** можно получить из диаграммы состояний параметры заявки любой вложенности, а также элементы массива. Пример: `{{conv[12345].ref[template].message.attachment.payload.buttons[0]}}`
