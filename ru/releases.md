...
1. В v 4.3 (ориентировочно - 7 августа  2019) строка с JSON-данными не будет восприниматься, как JSON-объект, если при работе с данными подразумевается обращение к его свойствам.<br>
...
1. В окне **Sharing settings** добавлен чекбокс для управления уведомлениями. По умолчанию отправка уведомлений ***включена***. Для предоставления доступа к объектам Corezoid без уведомления пользователя по электронной почте, необходимо снять чекбокс “Send notification about updates by email”.<br>
![img](interface/img/releases/v4.2.1_image1.png)<br>

**Исправлено:**

1. Некорректное расположение объекта при перемещении процесса (**Move to...**) с созданием новой папки.
2. Ошибка восстановления узлов при многократном нажатии **Undo**.
3. Отображение в процессе уведомления **Undeployed version loaded** сразу после копирования или загрузки из файла.<br>
![img](interface/img/releases/v4.2.1_image2.png)
4. Экранирование специальных символов в объекте JSON в узле **API Call** при смене формата запроса с Default на Raw с типом параметров Array и Object.<br>
Пример:<br>
```
{"ops":"[{\"type\":\"list\",\"obj\":\"conv\",\"obj_id\":\"126979\",\"get_counter\":false}]"}
```
И другие скучные баги :)
