...
1. Экранирование специальных символов в объекте JSON в узле **API Call** при смене формата запроса с Default на Raw с типом параметров Array и Object.<br>
Пример:<br>
```
{"ops":"[{\"type\":\"list\",\"obj\":\"conv\",\"obj_id\":\"126979\",\"get_counter\":false}]"}
```
2. Некорректное расположение объекта при перемещении процесса (**Move to...**) с созданием новой папки.
3. Ошибка восстановления узлов при многократном нажатии **Undo**.
4. Отображение в процессе уведомления **Undeployed version loaded** сразу после копирования или загрузки из файла.<br>
