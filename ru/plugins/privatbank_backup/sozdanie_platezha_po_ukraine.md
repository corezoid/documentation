...
Клонируйте [папку "Creation of payment in Ukraine"](https://admin.corezoid.com/folder/conv/6081) для получения процесса и дашборда.
...
*   `recipient_acc` - счёт получателя
*   `recipient_mfo` - МФО банка получателя
*   `recipient_okpo` - ОКПО банка получателя
